...
This README provides code for training, testing, and deployings, different convolutional neural network model architectures on acoustic data using spectrogram images.
