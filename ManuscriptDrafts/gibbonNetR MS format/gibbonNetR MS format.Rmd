...
```{r, echo=FALSE, out.width="75%",fig.cap='Spectrograms of training clips for CNNs',fig.pos = "H"}
...
```{r, fig.cap='Evaluating performance of pretrained CNNs', echo=FALSE, warning=FALSE, message=FALSE, fig.pos = "H", results='hide',  fig.width=6.5}
