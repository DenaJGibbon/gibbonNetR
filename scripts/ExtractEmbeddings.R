...
#' @export
# Define the function
extract_embeddings_and_plot <- function(test_input, model_path, target_class) {
...
result <- extract_embeddings_and_plot("data/imagesmalaysiamulti/test",
                                    "data/multi/_output_unfrozen_TRUE_imagesmalaysiamulti_/_imagesmalaysiamulti_5_modelalexNet.pt",
                                    target_class='duet')
print(result)
